...
export const models: UtamuModel[] = [
  {
    id: 'm-001', name: 'Amina W.', slug: 'amina-w', city: 'Westlands', county: 'Nairobi', category: 'Premium Model', age: 24, height: '5ft 8in', rating: 4.96, reviews: 128, priceFrom: 8500, online: true, verified: true, elite: true, responseTime: 'Usually replies in 7 minutes', image: modelImages[0], gallery: [modelImages[6], modelImages[7], modelImages[8], modelImages[1], modelImages[2]], bio: 'Editorial and lifestyle model based in Nairobi, available for brand shoots, events, campaigns, and curated professional appearances.', specialties: ['Editorial', 'Luxury events', 'Beauty campaigns', 'Lifestyle content'], stats: { bookings: 84, profileViews: 18400, completion: 96, earnings: 482000 }, rates: [{ label: 'Portfolio access deposit', price: 500, duration: 'Instant unlock' }, { label: 'Brand shoot booking', price: 18500, duration: 'Half day' }, { label: 'Event appearance', price: 32000, duration: 'Evening' }]
  },
  {
    id: 'm-002', name: 'Nia K.', slug: 'nia-k', city: 'Kilimani', county: 'Nairobi', category: 'Commercial Talent', age: 22, height: '5ft 6in', rating: 4.91, reviews: 94, priceFrom: 6500, online: false, verified: true, elite: false, responseTime: 'Usually replies in 18 minutes', image: modelImages[1], gallery: [modelImages[1], modelImages[3], modelImages[4]], bio: 'Commercial model and creator for hospitality, wellness, fashion, and consumer brand productions.', specialties: ['Commercial shoots', 'Hospitality', 'Wellness', 'UGC'], stats: { bookings: 61, profileViews: 12100, completion: 91, earnings: 318000 }, rates: [{ label: 'Portfolio access deposit', price: 500, duration: 'Instant unlock' }, { label: 'Commercial shoot', price: 14500, duration: 'Half day' }]
  },
  {
    id: 'm-003', name: 'Talia M.', slug: 'talia-m', city: 'Nyali', county: 'Mombasa', category: 'Runway Model', age: 25, height: '5ft 10in', rating: 4.88, reviews: 76, priceFrom: 7200, online: true, verified: true, elite: true, responseTime: 'Usually replies in 12 minutes', image: modelImages[2], gallery: [modelImages[2], modelImages[5], modelImages[8]], bio: 'Runway and resort campaign talent with coastal availability and strong luxury hospitality experience.', specialties: ['Runway', 'Resort campaigns', 'Luxury hosting', 'Swimwear'], stats: { bookings: 48, profileViews: 9900, completion: 89, earnings: 276000 }, rates: [{ label: 'Portfolio access deposit', price: 500, duration: 'Instant unlock' }, { label: 'Runway booking', price: 22000, duration: 'Event' }]
  },
  {
    id: 'm-004', name: 'Zuri A.', slug: 'zuri-a', city: 'Milimani', county: 'Kisumu', category: 'Beauty Model', age: 23, height: '5ft 7in', rating: 4.84, reviews: 58, priceFrom: 5900, online: false, verified: false, elite: false, responseTime: 'Usually replies in 30 minutes', image: modelImages[4], gallery: [modelImages[4], modelImages[7]], bio: 'Beauty and skincare talent with a clean, polished look for campaigns and social-first productions.', specialties: ['Beauty', 'Skincare', 'Content shoots'], stats: { bookings: 31, profileViews: 7600, completion: 74, earnings: 146000 }, rates: [{ label: 'Portfolio access deposit', price: 500, duration: 'Instant unlock' }, { label: 'Beauty campaign', price: 12000, duration: 'Half day' }]
  },
];
...
export const categories = ['All', 'Premium Model', 'Commercial Talent', 'Runway Model', 'Beauty Model'];
