...
function MonetizationScreen() {
  ...
  const productActive = (product: any) => {
    ...
    if (product.category === 'listing') return listingActive && overview.model?.listing_tier === String(product.id || '').replace('tier-', '');
